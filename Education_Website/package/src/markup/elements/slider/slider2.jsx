								...
								<div className="row align-items-center">
									<div className="col-lg-7">
										<div className="content-inner">
											<h6 className="sub-title">{ t('_Slider2_title') } </h6>
											<h2 className="title text-primary"> { t('_Slider2_prim') }</h2>
											<p>{ t('_Slider2_para') }</p>
											<Link className="btn radius-xl m-r15 button-md white" to="/contact-1">{ t('_Slider2_contact') }</Link>
											<Link className="btn radius-xl button-md" to="/about-1">{ t('_Slider2_read_more') }</Link>
										</div>
									</div>
...
export default withTranslation()(Slider2);